...
(async () => {
  ...
  ok('single check → directive injected', inj.includes("Jovan's note"));
  ...
  ok('exchange → directive qualitative, no leak', inj.includes("Jovan's note") && !LEAK.test(inj));
  ...
  ok('swipe → the committed directive is replayed', mainInj().includes("Jovan's note"));
  ...
  ok('edit → still produces a fresh directive', mainInj().includes("Jovan's note"));
  ...
  ok('battle directive qualitative, no leak', inj.includes("Jovan's note") && !LEAK.test(inj));
  ...
  ok('war directive qualitative, no leak', inj.includes("Jovan's note") && !LEAK.test(inj));
  ...
  ok('fast mode duel → directive injected, no leak', inj.includes("Jovan's note") && !LEAK.test(inj));
